...
function Menu({ onFinishClick }) {
  return (
    <section id='cardapio' className='flex flex-col items-center justify-center px-5 py-16 text-white bg-center bg-cover bg-darker-gray' style={{ backgroundImage: "url('src/assets/menu-bg.png')" }}>
      <div className='flex items-center flex-col flex-1 px-[10rem] max-w-[85rem] py-10 bg-darker-gray'>
        ...
        <button className='px-3 py-1 mt-5 text-xl text-white bg-green-900' onClick={onFinishClick}>
          Pedir
        </button>
      </div>
    </section>
